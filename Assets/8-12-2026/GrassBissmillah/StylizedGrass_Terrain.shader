Shader "FantasyKingdom/StylizedGrass_Terrain"
{
    // =====================================================================
    // Stylized Interactive Grass Shader — Untuk Terrain Detail Grass.
    // Dioptimalkan untuk rumput detail painting Unity Terrain.
    // Dilengkapi 4 Pass Lengkap:
    //  1. ForwardLit   (UniversalForward)
    //  2. DepthOnly    (Universal Depth Prepass)
