// v2.5 — WuWa Toon Character: Dedicated Cloth & Props Shader
Shader "WuWa/Toon - Cloth (Pakaian & Props)"
{
    Properties
    {
        [HideInInspector] _MaterialType ("Material Type", Float) = 0
        ...
        // ── Standard Specular (Kain / Rambut) ──
        [Header(Cloth and Hair Specular)]
