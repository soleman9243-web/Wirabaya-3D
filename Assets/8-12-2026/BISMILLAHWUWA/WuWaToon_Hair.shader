// v2.5 — WuWa Toon Character: Dedicated Hair Shader with Dynamic Angel Ring ("Tuing-Tuing")
Shader "WuWa/Toon - Hair (Rambut - Angel Ring)"
{
    Properties
    {
        [HideInInspector] _MaterialType ("Material Type", Float) = 3
        ...
        // ── WuWa Hair Settings (Angel Ring / Tenshi no Wa "Tuing-Tuing") ──
        [Header(WuWa Hair Angel Ring Gloss)]
        ...
        _ShadowColorShift ("Shadow Warm(+) / Cool(-) Shift", Range(-1.0, 1.0)) = 0.05
        ...
        [HideInInspector] _Shading_Color ("Shading Color Fallback", Color) = (0.35, 0.35, 0.40, 1)
        [HideInInspector] _Cel_Shader_Offset ("Cel Offset Fallback", Float) = 0.5
        [HideInInspector] _Cel_Ramp_Smoothness ("Cel Smoothness Fallback", Float) = 0.04
