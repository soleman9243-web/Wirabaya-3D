namespace LifelikeMotion.IKFootPlacement
{
    ...
    public class IKSetup : MonoBehaviour
    {
        ...
        public bool SetupIKRig()
        {
            ...
            #region Adding Rig Builder component
            try
            {
                rigBuilder = gameObject.GetComponent<RigBuilder>();
                if (rigBuilder == null) rigBuilder = gameObject.AddComponent<RigBuilder>();
                Debug.Log("Added Rig Builder component!");
            }
            catch
            {
                Debug.LogError("Could not add Rig Builder component to the GameObject.");
                return false;
            }
            #endregion
            ...
            iKLegs.transform.localRotation = Quaternion.identity;

            rig = iKLegs.AddComponent<Rig>();
            ...
            iKConstraints.transform.localPosition = Vector3.zero;
            iKConstraints.transform.localRotation = Quaternion.identity;
